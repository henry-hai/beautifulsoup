...
class BeautifulSoup(Tag):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        :param replacer: A SoupReplacer. Tags matching the replacer's
         original tag name will be replaced with the alternative tag name
         during parsing. This is more memory efficient than replacing
         tags after parsing is complete.
